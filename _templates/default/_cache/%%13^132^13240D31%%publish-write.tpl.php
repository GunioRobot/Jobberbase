<?php /* Smarty version 2.6.26, created on 2009-12-01 09:02:43
...
<?php endif; ?></span>
				...
				<?php endif; ?>
				<fieldset><input type="checkbox" name="apply_online" id="apply_online" <?php if ($this->_tpl_vars['job']['apply_online'] == 1 || $this->_tpl_vars['is_apply'] == 1): ?>checked="checked"<?php endif; ?><?php if (! isset ( $this->_tpl_vars['job']['apply_online'] ) && ! isset ( $this->_tpl_vars['is_apply'] )): ?>checked="checked"<?php endif; ?> /><?php echo $this->_tpl_vars['translations']['publish']['apply_online']; ?>
</input></fieldset>
