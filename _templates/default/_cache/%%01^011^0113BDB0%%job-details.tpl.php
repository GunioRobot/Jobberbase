<?php /* Smarty version 2.6.26, created on 2009-12-01 09:04:04
         compiled from job-details.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'job-details.tpl', 9, false),)), $this); ?>
			<div id="job-details">
				...
				<div id="old-ad">
					<?php echo ((is_array($_tmp=$this->_tpl_vars['translations']['apply']['old_ad'])) ? $this->_run_mod_handler('replace', true, $_tmp, '%days%', @OLD_JOB_NOTIFY) : smarty_modifier_replace($_tmp, '%days%', @OLD_JOB_NOTIFY)); ?>
...
/img/icon-delete.png" alt="" />
						<?php if ($_SESSION['apply_allowed'] && $_SESSION['apply_allowed'] == -1): ?>
							<?php echo ((is_array($_tmp=$this->_tpl_vars['translations']['apply']['error_apply_timeout_not_passed'])) ? $this->_run_mod_handler('replace', true, $_tmp, '%minutes%', @MINUTES_BETWEEN_APPLY_TO_JOBS_FROM_SAME_IP) : smarty_modifier_replace($_tmp, '%minutes%', @MINUTES_BETWEEN_APPLY_TO_JOBS_FROM_SAME_IP)); ?>
