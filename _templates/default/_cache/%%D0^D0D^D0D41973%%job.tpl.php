...
"><?php echo $this->_tpl_vars['translations']['recommend']['title']; ?>
				...
				<div id="number-views">
					<?php echo $this->_tpl_vars['translations']['jobs']['published_at']; ?>
 <strong><?php echo $this->_tpl_vars['job']['created_on']; ?>
</strong><br />
					<?php echo $this->_tpl_vars['translations']['jobs']['viewed']; ?>
: <strong><?php echo $this->_tpl_vars['job']['views_count']; ?>
</strong> <?php echo $this->_tpl_vars['translations']['jobs']['times']; ?>
